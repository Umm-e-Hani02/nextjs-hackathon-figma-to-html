...
export default function Navbar() {
  return (
    <nav className="max-w-screen w-full h-[124px] bg-white flex flex-wrap m-auto px-5 md:px-8 lg:px-16 xl:px-24 items-center overflow-x-hidden border-b border-b-gray-200">
